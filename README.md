...
Проект готов: все пути относительные, базовый путь `/имя-репозитория/` подставляет GitHub Actions
при сборке (`vite build --base=/<repo>/`), манифест и service worker работают из подпапки.
