...
### Шаг 3. Разрешить вход через VK ID (обязательно!)
...
### Шаг 4. Установка на телефон жены (PWA)
...
- [ ] Вход через ВК работает (redirect URI добавлен в dev.vk.com), данные сохраняются
- [ ] После перезагрузки страницы сессия не слетает (токен в localStorage)
